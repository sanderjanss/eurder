...
class DefaultUserServiceTest {
    ...
    public void before() {
        ...
        admin1 = new CreateUserDTO("Admin", "Janssens", "AdminTest1@email.com", address2, "0411111111", Role.ADMIN);
        admin2 = new User("Admin2", "Janssens", "AdminTest2@email.com", address2, "0411111111", Role.ADMIN);
        admin3 = new User("Admin3", "Janssens", "AdminTest3@email.com", address2, "0411111111", Role.ADMIN);

        userRepository.registerCustomer(customer1);
        userRepository.registerCustomer(customer3);
        userRepository.registerAdmin(admin3);
    }
...
//        Assertions.assertThat(userService.getAllCustomers(admin3.getUserId(), null)).containsAll(userMapper.toDtoList(List.of(customer1, customer3)));
//    }
//
//    @Test
//    public void givenATestDatabase_whenAnAdminUserTriesToAccesTheUserDatabaseWithMemberId_thenReturnThatCustomer(){
//        Assertions.assertThat(userService.getAllCustomers(admin2.getUserId(), null)).containsAll(userMapper.toDtoList(List.of(customer1, customer3)));
//    }
